      ...
      <header className="bg-white shadow">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <h1 className="text-xl font-bold text-gray-800">ARC Player Dashboard</h1>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <aside className="w-64 mr-8">
          <nav className="bg-white shadow rounded-lg p-4">
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  to="/player/opportunities"
                  className={`flex items-center px-4 py-2 rounded-md transition-colors ${
                    location.pathname === '/player/opportunities'
                      ? 'bg-blue-100 text-blue-700'
                      : 'text-gray-700 hover:bg-gray-100'
                  }`}
                >
              ...
              <li>
                <Link
                  to="/player/my-opportunities"
                  className={`flex items-center px-4 py-2 rounded-md transition-colors ${
                    location.pathname === '/player/my-opportunities'
                      ? 'bg-blue-100 text-blue-700'
                      : 'text-gray-700 hover:bg-gray-100'
                  }`}
                >
